...
object Shapefile {
    ...
    fun parse(workDir: File, paths: List<String>, maxVertices: Int = MAX_VERTICES, mustBeWGS84: Boolean = false, nameCheck: (String) -> Throwable? = { null }, recordf: (DbfRecord) -> Int? = { null }, polyReceiver: (PolyPts) -> Unit = {}): Result<File> {
        return try {
